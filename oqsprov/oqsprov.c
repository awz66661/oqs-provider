...
if ((envval = getenv("OQS_OID_HQC128"))) oqs_oid_alg_list[76] = envval;

if ((envval = getenv("OQS_OID_P256_HQC128"))) oqs_oid_alg_list[78] = envval;
if ((envval = getenv("OQS_OID_X25519_HQC128"))) oqs_oid_alg_list[80] = envval;
if ((envval = getenv("OQS_OID_HQC192"))) oqs_oid_alg_list[82] = envval;

if ((envval = getenv("OQS_OID_P384_HQC192"))) oqs_oid_alg_list[84] = envval;
if ((envval = getenv("OQS_OID_X448_HQC192"))) oqs_oid_alg_list[86] = envval;
if ((envval = getenv("OQS_OID_HQC256"))) oqs_oid_alg_list[88] = envval;

if ((envval = getenv("OQS_OID_P521_HQC256"))) oqs_oid_alg_list[90] = envval;

#define OQS_KEMOID_CNT 90+2
#else
