...
///// OQS_TEMPLATE_FRAGMENT_GROUP_NAMES_START
    ...
    OQS_GROUP_ENTRY(hqc128, hqc128, hqc128, 38),

    OQS_GROUP_ENTRY(p256_hqc128, p256_hqc128, p256_hqc128, 39),
    OQS_GROUP_ENTRY(x25519_hqc128, x25519_hqc128, x25519_hqc128, 40),
#endif
#ifdef OQS_ENABLE_KEM_hqc_192
    OQS_GROUP_ENTRY(hqc192, hqc192, hqc192, 41),

    OQS_GROUP_ENTRY(p384_hqc192, p384_hqc192, p384_hqc192, 42),
    OQS_GROUP_ENTRY(x448_hqc192, x448_hqc192, x448_hqc192, 43),
#endif
#ifdef OQS_ENABLE_KEM_hqc_256
    OQS_GROUP_ENTRY(hqc256, hqc256, hqc256, 44),

    OQS_GROUP_ENTRY(p521_hqc256, p521_hqc256, p521_hqc256, 45),
#endif
...
int oqs_patch_codepoints() {
   ...
   if (getenv("OQS_CODEPOINT_HQC128")) oqs_group_list[38].group_id = atoi(getenv("OQS_CODEPOINT_HQC128"));
   if (getenv("OQS_CODEPOINT_P256_HQC128")) oqs_group_list[39].group_id = atoi(getenv("OQS_CODEPOINT_P256_HQC128"));
   if (getenv("OQS_CODEPOINT_X25519_HQC128")) oqs_group_list[40].group_id = atoi(getenv("OQS_CODEPOINT_X25519_HQC128"));
   if (getenv("OQS_CODEPOINT_HQC192")) oqs_group_list[41].group_id = atoi(getenv("OQS_CODEPOINT_HQC192"));
   if (getenv("OQS_CODEPOINT_P384_HQC192")) oqs_group_list[42].group_id = atoi(getenv("OQS_CODEPOINT_P384_HQC192"));
   if (getenv("OQS_CODEPOINT_X448_HQC192")) oqs_group_list[43].group_id = atoi(getenv("OQS_CODEPOINT_X448_HQC192"));
   if (getenv("OQS_CODEPOINT_HQC256")) oqs_group_list[44].group_id = atoi(getenv("OQS_CODEPOINT_HQC256"));
   if (getenv("OQS_CODEPOINT_P521_HQC256")) oqs_group_list[45].group_id = atoi(getenv("OQS_CODEPOINT_P521_HQC256"));
